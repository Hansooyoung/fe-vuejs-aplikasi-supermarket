  ...
  <DefaultLayoutOperator>
    <div class="grid">
      <div class="flex flex-col gap-9">
        <DefaultCard cardTitle="Tambah Barang Baru">
          <form @submit.prevent="handleSubmit" class="p-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div class="space-y-5">
                ...
                <!-- Image Upload -->
                <div class="mb-4">
                  <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Gambar Barang</label>
                  <div class="flex items-center space-x-4">
                  ...
                  <div v-if="previewImage" class="mt-4 flex flex-col items-center">
                    ...
                    />
                    <button 
                      @click="previewImage = null; formData.gambar = null" 
...
>
  ...
  <!-- Modal panel - centered with max width and height -->
