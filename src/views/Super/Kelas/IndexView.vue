...
const confirmDelete = (kelas) => {
  itemToDelete.value = kelas;
  modalMessage.value = 'Apakah Anda yakin ingin menghapus kelas ini?';
    ...
    >
      ...
      <div class="max-w-full overflow-x-auto">
        <div class="flex justify-start mb-4">
          <button 
            @click="$router.push({ name: 'kelas-super.create' })"
            ...
            <tr v-for="(kelas, index) in kelasData" :key="index">
              ...
              <td class="py-5 px-4">
                <div class="flex items-center space-x-3.5">
                  <div class="flex items-center space-x-3.5">
                  <button @click="$router.push({ name: 'kelas-super.update', params: { id: kelas.id } })" class="hover:text-primary ">Edit</button>
                  <button @click="confirmDelete(kelas)" class="hover:text-primary">Delete</button>
                </div>
                </div>
              </td>
            </tr>
