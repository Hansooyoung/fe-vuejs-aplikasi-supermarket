    ...
    >
      ...
      <div class="max-w-full overflow-x-auto">
        <div class="flex justify-start mb-4">
          <button 
            @click="$router.push({ name: 'jurusan-super.create' })"
            ...
            <tr v-for="(jurusan, index) in jurusanData" :key="index">
              ...
              <td class="py-5 px-4">
                <div class="flex items-center space-x-3.5">
                  <button @click="$router.push({ name: 'jurusan-super.update', params: { id: jurusan.id } })" class="hover:text-primary ">Edit</button>
