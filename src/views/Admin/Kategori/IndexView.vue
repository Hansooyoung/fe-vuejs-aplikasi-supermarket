...
const fetchDataKategori = async () => {
  try {
    const response = await api.request({
      method: 'GET',
      url: `/kategori?page=${currentPage.value}&search=${searchQuery.value}`,
      headers: {
    ...
    kategoriData.value = response.data.data.data
