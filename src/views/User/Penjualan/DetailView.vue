  ...
  <DefaultLayoutUser>
    ...
    >
      ...
      <div class="mb-6 p-4 border border-gray-300 rounded-md bg-gray-50 dark:bg-meta-4">
        ...
        <p class="text-lg text-black dark:text-white"><strong>Total Keuntungan:</strong> {{ penjualan?.total_keuntungan }}</p>
        <p class="text-lg text-black dark:text-white"><strong>Total Penjualan:</strong> Rp{{ penjualan?.total_penjualan }}</p>
      </div>
        ...
        <table class="w-full table-auto">
          ...
          <tbody>
            <tr v-for="(detail, index) in detailData" :key="index">
              ...
              <td class="py-5 px-4">
                <p class="text-black dark:text-white">{{ detail.harga_jual }}</p>
              </td>
              <td class="py-5 px-4">
