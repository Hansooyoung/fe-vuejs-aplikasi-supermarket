...
const menuGroups = ref([
  {
    ...
    menuItems: [
...

      {
        ...
        route: '#',
        children: [
          { label: 'Transaksi', route: '/user/dashboard/penjualan/create' },
          { label: 'History', route: '/user/dashboard/penjualan' },
        ]
      },
      {
        icon: `<svg
      ...
      },
      {
        ...
        label: 'Riwayat Aktfitas',
        route: '/user/dashboard/riwayat-aktifitas',
      },
