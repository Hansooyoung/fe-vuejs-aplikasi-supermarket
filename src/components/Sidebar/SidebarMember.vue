...
const menuGroups = ref([
  {
    ...
    menuItems: [
...

      {
        ...
        route: '#',
        children: [
          { label: 'Daftar Pengajuan Barang', route: '/member/dashboard/pengajuan' },
          { label: 'Buat Pengajuan Barang', route: '/member/dashboard/pengajuan/create' },
        ]
      },
      {
        icon: `<svg
        ...
        route: '/member/dashboard/riwayat-aktifitas',
      },
    ]
  },
])
